...
import { findPath, pointInPolygon, snapToPolygon } from "./pathfinding.js";
...
import { npcWanderHost } from "./behaviors/walker.js";
...
export class NPC {
    ...
    constructor(scene, config) {
        ...
        /** @type {import("./behaviors/WanderBehavior.js").WanderBehavior | import("./behaviors/PatrolBehavior.js").PatrolBehavior | import("./behaviors/FollowBehavior.js").FollowBehavior | null} */
        this._behavior = null;
        ...
        /** @type {import("./HotspotManager.js").HotspotConfig} */
        this.hotspotConfig = {
        ...
        this._onSelfClick = (/** @type {import("./HotspotManager.js").HotspotConfig} */ config) => {
     ...
     * @param {import("./behaviors/WanderBehavior.js").WanderOptions} [opts]
     */
    wander(opts = {}) {
     ...
     * @param {import("./behaviors/PatrolBehavior.js").PatrolWaypoint[]} waypoints
     * @param {import("./behaviors/PatrolBehavior.js").PatrolOptions} [opts]
     */
     ...
     * @param {import("./behaviors/FollowBehavior.js").FollowOptions} [opts]
     */
    follow(opts = {}) {
        this._behavior?.destroy();
     ...
     * @returns {import("./Wearables.js").Wearable | null}
     */
