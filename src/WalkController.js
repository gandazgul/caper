 ...
 * @property {import("./perspective.js").PerspectiveConfig | null} [perspective]
...
export class WalkController {
     ...
     * @param {import("./perspective.js").PerspectiveConfig} [opts.perspective] -
    ...
    constructor(scene, /** @type {WalkControllerOpts} */ opts) {
        ...
        if (!opts.nonControllable) {
            ...
            this._onHotspotClick = (/** @type {import("./HotspotManager.js").HotspotConfig} */ hotspot) =>
    ...
    /** @param {import("./HotspotManager.js").HotspotConfig} hotspot */
