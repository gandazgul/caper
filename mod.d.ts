...
export class PropEngine {
	...
	sprites: Map<string, import("phaser").GameObjects.Sprite | PropStack>;
	...
	ctxFor(prop: Prop, draggedId?: string): {
		...
		scene: any;
		engine: PropEngine;
		sprite: Phaser.GameObjects.Sprite | PropStack;
...
declare class PropStack extends Phaser.GameObjects.Container {
	/**
	 * @param {Phaser.Scene} scene
	 * @param {number} x
	 * @param {number} y
	 ...
	 */
	constructor(scene: Phaser.Scene, x: number, y: number, texture: string, frame: string, config: PropStackConfig);
	textureKey: string;
	frameName: string;
	/** @type {PropStackConfig} */
	config: PropStackConfig;
	rebuildStack(): void;
...
export type PropState = {
	...
	/**
	 * - options for rendering as a stack of multiple sprites.
	 */
	stack?: PropStackConfig;
	onClick?: PropEffect[];
	onDrop?: {
		accepts: Condition;
		effects: PropEffect[];
...
export type Prop = {
	...
	/**
	 * - default options for rendering as a stack.
	 */
	stack?: PropStackConfig;
	bounds?: {
		x: number;
...
export type CharacterConfig = {
	...
	playable?: boolean;
	/**
	 * - whether the character wanders the scene when inactive (opt-in).
	 */
	wanderer?: boolean;
	largeBubble?: boolean;
...
export type IdleCharacterOptions = {
	/**
	 * - the specific playable character id to spawn. Defaults to the first inactive.
	 */
	characterId?: string;
	/**
	 * - text to
...
export class AdventureScene extends Phaser.Scene {
	 ...
	 */
	spawnIdleCharacters(opts?: IdleCharacterOptions & {
		wanderers?: string[];
	}): IdleCharacter[];
	/**
...
export type AdventureSceneConfig = {
	...
	indoors?: boolean;
	/**
	 * - hide the active character and disable free-walk clicks while keeping hotspot arrival routing.
	 */
	suppressActiveCharacter?: boolean;
	/**
 ...
 */
export function readEngineDebugConfig(env: Record<string, any> | undefined): Readonly<{
	loadSave: any;
	startScene: any;
	chapter: any;
	reset: boolean;
